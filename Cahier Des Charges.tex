...
\begin{document}
    ...
    \begin{indt}{\section{Conclusion}}
        Finalement “A Slime's Journey” est un jeu de plateforme 2D produit grâce à Unity en C$\#$. En son sein, un choix de sprites, décors, musiques et d'univers rend le jeu immersif. Le tout accompagné d'une communication sur divers réseaux sociaux, ainsi qu'un site officiel donnant accès à la dernière version du jeu et informant la communauté du jeu de chaque nouvelle mise à jour.
    \end{indt}
